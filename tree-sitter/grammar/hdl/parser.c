...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_chip_body_repeat1, 2, 0, 0),
  [11] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_chip_body_repeat1, 2, 0, 0), SHIFT_REPEAT(73),
  [14] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_chip_body_repeat1, 2, 0, 0), SHIFT_REPEAT(69),
  [17] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_chip_body_repeat1, 2, 0, 0), SHIFT_REPEAT(56),
  [20] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_chip_body, 1, 0, 0),
  [22] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [24] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [26] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [28] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parts_body_repeat1, 2, 0, 0),
  [30] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_parts_body_repeat1, 2, 0, 0),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_parts_body_repeat1, 2, 0, 0), SHIFT_REPEAT(55),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parts_body, 3, 0, 0),
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parts_body, 3, 0, 0),
  [39] = {.entry = {.count = 1, .reusable = false}}, SHIFT(55),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parts_body, 2, 0, 0),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parts_body, 2, 0, 0),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_part, 4, 0, 9),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_part, 4, 0, 9),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_part, 5, 0, 9),
  [58] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_part, 5, 0, 9),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_part, 6, 0, 9),
  [62] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_part, 6, 0, 9),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_clocked_body, 3, 0, 0),
  ...
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_builtin_body, 3, 0, 5),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_clocked_body, 4, 0, 0),
  [80] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_part_repeat1, 2, 0, 0), SHIFT_REPEAT(49),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_part_repeat1, 2, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [87] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [89] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_chip_header, 2, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_in_section_repeat1, 2, 0, 1),
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_in_section_repeat1, 2, 0, 4), SHIFT_REPEAT(54),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_in_section_repeat1, 2, 0, 4),
  [100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_out_section, 3, 0, 6),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [108] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [110] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_clocked_body_repeat1, 2, 0, 0), SHIFT_REPEAT(66),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_clocked_body_repeat1, 2, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_out_section_repeat1, 2, 0, 6),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_out_section, 4, 0, 7),
  [123] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_out_section_repeat1, 2, 0, 8), SHIFT_REPEAT(47),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_out_section_repeat1, 2, 0, 8),
  ...
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_connection, 3, 0, 10),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bus_identifier, 4, 0, 0),
  ...
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_chip_definition, 6, 0, 2),
  ...
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_in_section, 4, 0, 3),
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_in_section, 3, 0, 1),
