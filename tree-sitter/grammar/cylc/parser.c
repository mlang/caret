...
static const TSCharacterRange aux_sym_nametag_token1_character_set_1[] = {
...
static const TSCharacterRange aux_sym_nametag_token2_character_set_1[] = {
  {'\t', '\t'}, {' ', ' '}, {'%', '%'}, {'+', '+'}, {'-', '-'}, {'0', '9'}, {'@', 'Z'}, {'_', '_'},
...
static const TSCharacterRange aux_sym_key_token1_character_set_1[] = {
  {'!', '!'}, {'$', '$'}, {'(', ')'}, {'+', '+'}, {'-', ':'}, {'A', 'Z'}, {'^', '_'}, {'a', 'z'},
...
static const TSCharacterRange aux_sym_key_token2_character_set_1[] = {
  {' ', '!'}, {'$', '$'}, {'(', ')'}, {'+', '+'}, {'-', ':'}, {'A', 'Z'}, {'^', '_'}, {'a', 'z'},
  {0xaa, 0xaa}, {0xb2, 0xb3}, {0xb5, 0xb5}, {0xb9, 0xba}, {0xbc, 0xbe}, {0xc0, 0xd6}, {0xd8, 0xf6}, {0xf8, 0x2c1},
  {0x2c6, 0x2d1}, {0x2e0, 0x2e4}, {0x2ec, 0x2ec}, {0x2ee, 0x2ee}, {0x370, 0x374}, {0x376, 0x377}, {0x37a, 0x37d}, {0x37f, 0x37f},
  {0x386, 0x386}, {0x388, 0x38a}, {0x38c, 0x38c}, {0x38e, 0x3a1}, {0x3a3, 0x3f5}, {0x3f7, 0x481}, {0x48a, 0x52f}, {0x531, 0x556},
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(aux_sym_key_token2_character_set_1, 775, lookahead)) ADVANCE(146);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(162);
      END_STATE();
    ...
    case 6:
      ...
      if (set_contains(aux_sym_nametag_token2_character_set_1, 776, lookahead)) ADVANCE(140);
      END_STATE();
    case 7:
      ADVANCE_MAP(
        '\n', 162,
    ...
    case 31:
      ...
      if (set_contains(aux_sym_nametag_token2_character_set_1, 776, lookahead)) ADVANCE(141);
      END_STATE();
    case 32:
      ADVANCE_MAP(
        '#', 115,
    ...
    case 34:
      ...
      if (set_contains(aux_sym_nametag_token1_character_set_1, 771, lookahead)) ADVANCE(140);
      END_STATE();
    case 35:
      if (lookahead == '#') ADVANCE(115);
      if (lookahead == '\\') ADVANCE(12);
    ...
    case 101:
      ...
      if (set_contains(aux_sym_key_token2_character_set_1, 775, lookahead)) ADVANCE(145);
      END_STATE();
    case 102:
      if (eof) ADVANCE(104);
      ADVANCE_MAP(
    ...
    case 145:
      ...
      if (set_contains(aux_sym_key_token1_character_set_1, 775, lookahead)) ADVANCE(145);
      END_STATE();
    case 146:
