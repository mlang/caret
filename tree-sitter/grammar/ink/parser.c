...
static const TSCharacterRange sym_vocabulary_character_set_1[] = {
...
static const TSCharacterRange aux_sym_other_token1_character_set_1[] = {
  ...
  {0x3260, 0x327f}, {0x328a, 0x32b0}, {0x32c0, 0x33ff}, {0x4dc0, 0x4dff}, {0xa48d, 0xa4cf}, {0xa4fe, 0xa4ff}, {0xa60d, 0xa60f}, {0xa62c, 0xa63f},
  {0xa66f, 0xa67e}, {0xa69e, 0xa69f}, {0xa6f0, 0xa716}, {0xa720, 0xa721}, {0xa789, 0xa78a}, {0xa7ce, 0xa7cf}, {0xa7d2, 0xa7d2}, {0xa7d4, 0xa7d4},
  {0xa7dd, 0xa7f1}, {0xa802, 0xa802}, {0xa806, 0xa806}, {0xa80b, 0xa80b}, {0xa823, 0xa82f}, {0xa836, 0xa83f}, {0xa874, 0xa881}, {0xa8b4, 0xa8cf},
  {0xa8da, 0xa8f1}, {0xa8f8, 0xa8fa}, {0xa8fc, 0xa8fc}, {0xa8ff, 0xa8ff}, {0xa926, 0xa92f}, {0xa947, 0xa95f}, {0xa97d, 0xa983}, {0xa9b3, 0xa9ce},
  {0xa9da, 0xa9df}, {0xa9e5, 0xa9e5}, {0xa9ff, 0xa9ff}, {0xaa29, 0xaa3f}, {0xaa43, 0xaa43}, {0xaa4c, 0xaa4f}, {0xaa5a, 0xaa5f}, {0xaa77, 0xaa79},
  ...
  {0xab6a, 0xab6f}, {0xabe3, 0xabef}, {0xabfa, 0xabff}, {0xd7a4, 0xd7af}, {0xd7c7, 0xd7ca}, {0xd7fc, 0xf8ff}, {0xfa6e, 0xfa6f}, {0xfada, 0xfaff},
  ...
  {0x107bb, 0x107ff}, {0x10806, 0x10807}, {0x10809, 0x10809}, {0x10836, 0x10836}, {0x10839, 0x1083b}, {0x1083d, 0x1083e}, {0x10856, 0x10857}, {0x10877, 0x10878},
  {0x1089f, 0x108a6}, {0x108b0, 0x108df}, {0x108f3, 0x108f3}, {0x108f6, 0x108fa}, {0x1091c, 0x1091f}, {0x1093a, 0x1097f}, {0x109b8, 0x109bb}, {0x109d0, 0x109d1},
  {0x10a01, 0x10a0f}, {0x10a14, 0x10a14}, {0x10a18, 0x10a18}, {0x10a36, 0x10a3f}, {0x10a49, 0x10a5f}, {0x10a7f, 0x10a7f}, {0x10aa0, 0x10abf}, {0x10ac8, 0x10ac8},
  {0x10ae5, 0x10aea}, {0x10af0, 0x10aff}, {0x10b36, 0x10b3f}, {0x10b56, 0x10b57}, {0x10b73, 0x10b77}, {0x10b92, 0x10ba8}, {0x10bb0, 0x10bff}, {0x10c49, 0x10c7f},
  {0x10cb3, 0x10cbf}, {0x10cf3, 0x10cf9}, {0x10d24, 0x10d2f}, {0x10d3a, 0x10d3f}, {0x10d66, 0x10d6e}, {0x10d86, 0x10e5f}, {0x10e7f, 0x10e7f}, {0x10eaa, 0x10eaf},
  {0x10eb2, 0x10ec1}, {0x10ec5, 0x10eff}, {0x10f28, 0x10f2f}, {0x10f46, 0x10f50}, {0x10f55, 0x10f6f}, {0x10f82, 0x10faf}, {0x10fcc, 0x10fdf}, {0x10ff7, 0x11002},
  {0x11038, 0x11051}, {0x11070, 0x11070}, {0x11073, 0x11074}, {0x11076, 0x11082}, {0x110b0, 0x110cf}, {0x110e9, 0x110ef}, {0x110fa, 0x11102}, {0x11127, 0x11135},
  {0x11140, 0x11143}, {0x11145, 0x11146}, {0x11148, 0x1114f}, {0x11173, 0x11175}, {0x11177, 0x11182}, {0x111b3, 0x111c0}, {0x111c5, 0x111cf}, {0x111db, 0x111db},
  {0x111dd, 0x111e0}, {0x111f5, 0x111ff}, {0x11212, 0x11212}, {0x1122c, 0x1123e}, {0x11241, 0x1127f}, {0x11287, 0x11287}, {0x11289, 0x11289}, {0x1128e, 0x1128e},
  {0x1129e, 0x1129e}, {0x112a9, 0x112af}, {0x112df, 0x112ef}, {0x112fa, 0x11304}, {0x1130d, 0x1130e}, {0x11311, 0x11312}, {0x11329, 0x11329}, {0x11331, 0x11331},
  {0x11334, 0x11334}, {0x1133a, 0x1133c}, {0x1133e, 0x1134f}, {0x11351, 0x1135c}, {0x11362, 0x1137f}, {0x1138a, 0x1138a}, {0x1138c, 0x1138d}, {0x1138f, 0x1138f},
  {0x113b6, 0x113b6}, {0x113b8, 0x113d0}, {0x113d2, 0x113d2}, {0x113d4, 0x113ff}, {0x11435, 0x11446}, {0x1144b, 0x1144f}, {0x1145a, 0x1145e}, {0x11462, 0x1147f},
  {0x114b0, 0x114c3}, {0x114c6, 0x114c6}, {0x114c8, 0x114cf}, {0x114da, 0x1157f}, {0x115af, 0x115d7}, {0x115dc, 0x115ff}, {0x11630, 0x11643}, {0x11645, 0x1164f},
  {0x1165a, 0x1167f}, {0x116ab, 0x116b7}, {0x116b9, 0x116bf}, {0x116ca, 0x116cf}, {0x116e4, 0x116ff}, {0x1171b, 0x1172f}, {0x1173c, 0x1173f}, {0x11747, 0x117ff},
  {0x1182c, 0x1189f}, {0x118f3, 0x118fe}, {0x11907, 0x11908}, {0x1190a, 0x1190b}, {0x11914, 0x11914}, {0x11917, 0x11917}, {0x11930, 0x1193e}, {0x11940, 0x11940},
  {0x11942, 0x1194f}, {0x1195a, 0x1199f}, {0x119a8, 0x119a9}, {0x119d1, 0x119e0}, {0x119e2, 0x119e2}, {0x119e4, 0x119ff}, {0x11a01, 0x11a0a}, {0x11a33, 0x11a39},
  {0x11a3b, 0x11a4f}, {0x11a51, 0x11a5b}, {0x11a8a, 0x11a9c}, {0x11a9e, 0x11aaf}, {0x11af9, 0x11bbf}, {0x11be1, 0x11bef}, {0x11bfa, 0x11bff}, {0x11c09, 0x11c09},
  {0x11c2f, 0x11c3f}, {0x11c41, 0x11c4f}, {0x11c6d, 0x11c71}, {0x11c90, 0x11cff}, {0x11d07, 0x11d07}, {0x11d0a, 0x11d0a}, {0x11d31, 0x11d45}, {0x11d47, 0x11d4f},
  {0x11d5a, 0x11d5f}, {0x11d66, 0x11d66}, {0x11d69, 0x11d69}, {0x11d8a, 0x11d97}, {0x11d99, 0x11d9f}, {0x11daa, 0x11edf}, {0x11ef3, 0x11f01}, {0x11f03, 0x11f03},
  {0x11f11, 0x11f11}, {0x11f34, 0x11f4f}, {0x11f5a, 0x11faf}, {0x11fb1, 0x11fbf}, {0x11fd5, 0x11fff}, {0x1239a, 0x123ff}, {0x1246f, 0x1247f}, {0x12544, 0x12f8f},
  {0x12ff1, 0x12fff}, {0x13430, 0x13440}, {0x13447, 0x1345f}, {0x143fb, 0x143ff}, {0x14647, 0x160ff}, {0x1611e, 0x1612f}, {0x1613a, 0x167ff}, {0x16a39, 0x16a3f},
  {0x16a5f, 0x16a5f}, {0x16a6a, 0x16a6f}, {0x16abf, 0x16abf}, {0x16aca, 0x16acf}, {0x16aee, 0x16aff}, {0x16b30, 0x16b3f}, {0x16b44, 0x16b4f}, {0x16b5a, 0x16b5a},
  {0x16b62, 0x16b62}, {0x16b78, 0x16b7c}, {0x16b90, 0x16d3f}, {0x16d6d, 0x16d6f}, {0x16d7a, 0x16e3f}, {0x16e97, 0x16eff}, {0x16f4b, 0x16f4f}, {0x16f51, 0x16f92},
  {0x16fa0, 0x16fdf}, {0x16fe2, 0x16fe2}, {0x16fe4, 0x16fff}, {0x187f8, 0x187ff}, {0x18cd6, 0x18cfe}, {0x18d09, 0x1afef}, {0x1aff4, 0x1aff4}, {0x1affc, 0x1affc},
  ...
  {0x1bc7d, 0x1bc7f}, {0x1bc89, 0x1bc8f}, {0x1bc9a, 0x1ccef}, {0x1ccfa, 0x1d2bf}, {0x1d2d4, 0x1d2df}, {0x1d2f4, 0x1d35f}, {0x1d379, 0x1d3ff}, {0x1d455, 0x1d455},
  {0x1d49d, 0x1d49d}, {0x1d4a0, 0x1d4a1}, {0x1d4a3, 0x1d4a4}, {0x1d4a7, 0x1d4a8}, {0x1d4ad, 0x1d4ad}, {0x1d4ba, 0x1d4ba}, {0x1d4bc, 0x1d4bc}, {0x1d4c4, 0x1d4c4},
  ...
  {0x1d551, 0x1d551}, {0x1d6a6, 0x1d6a7}, {0x1d6c1, 0x1d6c1}, {0x1d6db, 0x1d6db}, {0x1d6fb, 0x1d6fb}, {0x1d715, 0x1d715}, {0x1d735, 0x1d735}, {0x1d74f, 0x1d74f},
  {0x1d76f, 0x1d76f}, {0x1d789, 0x1d789}, {0x1d7a9, 0x1d7a9}, {0x1d7c3, 0x1d7c3}, {0x1d7cc, 0x1d7cd}, {0x1d800, 0x1deff}, {0x1df1f, 0x1df24}, {0x1df2b, 0x1e02f},
  {0x1e06e, 0x1e0ff}, {0x1e12d, 0x1e136}, {0x1e13e, 0x1e13f}, {0x1e14a, 0x1e14d}, {0x1e14f, 0x1e28f}, {0x1e2ae, 0x1e2bf}, {0x1e2ec, 0x1e2ef}, {0x1e2fa, 0x1e4cf},
  {0x1e4ec, 0x1e4ef}, {0x1e4fa, 0x1e5cf}, {0x1e5ee, 0x1e5ef}, {0x1e5fb, 0x1e7df}, {0x1e7e7, 0x1e7e7}, {0x1e7ec, 0x1e7ec}, {0x1e7ef, 0x1e7ef}, {0x1e7ff, 0x1e7ff},
  {0x1e8c5, 0x1e8c6}, {0x1e8d0, 0x1e8ff}, {0x1e944, 0x1e94a}, {0x1e94c, 0x1e94f}, {0x1e95a, 0x1ec70}, {0x1ecac, 0x1ecac}, {0x1ecb0, 0x1ecb0}, {0x1ecb5, 0x1ed00},
  {0x1ed2e, 0x1ed2e}, {0x1ed3e, 0x1edff}, {0x1ee04, 0x1ee04}, {0x1ee20, 0x1ee20}, {0x1ee23, 0x1ee23}, {0x1ee25, 0x1ee26}, {0x1ee28, 0x1ee28}, {0x1ee33, 0x1ee33},
  ...
  {0x1eea4, 0x1eea4}, {0x1eeaa, 0x1eeaa}, {0x1eebc, 0x1f0ff}, {0x1f10d, 0x1fbef}, {0x1fbfa, 0x1ffff}, {0x2a6e0, 0x2a6ff}, {0x2b73a, 0x2b73f}, {0x2b81e, 0x2b81f},
  {0x2cea2, 0x2ceaf}, {0x2ebe1, 0x2ebef}, {0x2ee5e, 0x2f7ff}, {0x2fa1e, 0x2ffff}, {0x3134b, 0x3134f}, {0x323b0, 0x10ffff},
};

static const TSCharacterRange aux_sym_word_other_token1_character_set_1[] = {
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 771, lookahead)) ADVANCE(57);
      END_STATE();
    case 1:
    ...
    case 3:
      ...
      if (set_contains(sym_identifier_character_set_1, 771, lookahead)) ADVANCE(48);
      if (lookahead != 0 &&
    ...
    case 23:
      ACCEPT_TOKEN(aux_sym_gather_mark_token1);
      if (set_contains(sym_vocabulary_character_set_1, 772, lookahead)) ADVANCE(48);
      END_STATE();
    case 24:
    ...
    case 59:
      ...
      if (lookahead == 0xa0 ||
          ...
          lookahead == 0x205f ||
          lookahead == 0x3000) ADVANCE(59);
      if ((!eof && set_contains(aux_sym_other_token1_character_set_1, 774, lookahead))) ADVANCE(58);
      END_STATE();
    case 60:
      ACCEPT_TOKEN(aux_sym_other_token1);
      if (lookahead == '#') ADVANCE(33);
    ...
    case 65:
      ...
      if (lookahead == 0xa0 ||
          ...
          lookahead == 0x205f ||
          lookahead == 0x3000) ADVANCE(65);
      if ((!eof && set_contains(aux_sym_word_other_token1_character_set_1, 775, lookahead))) ADVANCE(64);
      END_STATE();
    case 66:
      ACCEPT_TOKEN(aux_sym_word_other_token1);
      if (lookahead == '-') ADVANCE(48);
