...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    [sym_content] = STATE(124),
    [sym_markdown] = STATE(70),
    [sym_tag] = STATE(70),
    [sym_annotation] = STATE(70),
    [sym_interpolation] = STATE(70),
    [aux_sym_content_repeat1] = STATE(70),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [3] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_content, 0, 0, 0),
  [5] = {.entry = {.count = 1, .reusable = true}}, SHIFT(111),
  [7] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [9] = {.entry = {.count = 1, .reusable = false}}, SHIFT(118),
  [11] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_open, 2, 0, 1),
  ...
  [57] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(150),
  [60] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [63] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(98),
  [72] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  [80] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(122),
  [83] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0), SHIFT_REPEAT(150),
  [86] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [89] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0), SHIFT_REPEAT(98),
  [98] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  [101] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0), SHIFT_REPEAT(122),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2, 0, 0),
  ...
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__space, 2, 0, 0),
  [135] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__space, 2, 0, 0), SHIFT_REPEAT(19),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 3, 0, 7),
  [140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(146),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 3, 0, 7),
  [144] = {.entry = {.count = 1, .reusable = true}}, SHIFT(90),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 0),
  [148] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 0), SHIFT_REPEAT(146),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 0),
  [153] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 0), SHIFT_REPEAT(90),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 2, 0, 7),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2, 0, 7),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_tail, 2, 0, 9),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_tail, 2, 0, 9),
  ...
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable_tail, 3, 0, 0),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_tail, 3, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function, 3, 0, 8),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function, 3, 0, 8),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_function_parameters_repeat1, 2, 0, 0),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_parameters_repeat1, 2, 0, 0),
  [184] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_compound, 1, 0, 0),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_compound, 1, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primitive, 1, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primitive, 1, 0, 0),
  ...
  [207] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_hash, 2, 0, 0),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hash, 2, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_parameters, 1, 0, 0),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameters, 1, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [217] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_hash, 3, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hash, 3, 0, 0),
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function, 4, 0, 8),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function, 4, 0, 8),
  [225] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_parameters, 2, 0, 0),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameters, 2, 0, 0),
  [229] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_hash, 4, 0, 0),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hash, 4, 0, 0),
  [233] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array, 4, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 4, 0, 0),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array, 3, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = false}}, SHIFT(144),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_open, 3, 0, 1),
  [245] = {.entry = {.count = 1, .reusable = false}}, SHIFT(106),
  [247] = {.entry = {.count = 1, .reusable = false}}, SHIFT(49),
  [249] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_open, 5, 0, 1),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_open, 4, 0, 1),
  [253] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_annotation_repeat1, 2, 0, 0), SHIFT_REPEAT(144),
  [256] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_annotation_repeat1, 2, 0, 0),
  [258] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_annotation_repeat1, 2, 0, 0), SHIFT_REPEAT(123),
  [261] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_annotation_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  [264] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_parameter_named, 3, 0, 10),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameter_named, 3, 0, 10),
  [268] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_parameter_tail, 2, 0, 0),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameter_tail, 2, 0, 0),
  [272] = {.entry = {.count = 1, .reusable = false}}, SHIFT(108),
  [274] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_parameter, 1, 0, 0),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_parameter, 1, 0, 0),
  [278] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__array_item, 2, 0, 0),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__array_item, 2, 0, 0),
  [282] = {.entry = {.count = 1, .reusable = false}}, SHIFT(142),
  [284] = {.entry = {.count = 1, .reusable = false}}, SHIFT(80),
  [286] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 0), SHIFT_REPEAT(142),
  [289] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 0), SHIFT_REPEAT(80),
  [292] = {.entry = {.count = 1, .reusable = false}}, SHIFT(105),
  [294] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_open, 1, 0, 1),
  ...
  [312] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute, 1, 0, 3),
  [314] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_content, 1, 0, 0),
  [316] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hash_repeat1, 2, 0, 0), SHIFT_REPEAT(127),
  [319] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hash_repeat1, 2, 0, 0), SHIFT_REPEAT(98),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_hash_repeat1, 2, 0, 0),
  [324] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__attribute_shorthand, 2, 0, 5),
  [326] = {.entry = {.count = 1, .reusable = true}}, SHIFT(141),
  [328] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__attribute_full, 3, 0, 6),
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2, 0, 0),
  [332] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2, 0, 0), SHIFT_REPEAT(111),
  [335] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_content_repeat1, 2, 0, 0), SHIFT_REPEAT(18),
  [338] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute, 1, 0, 2),
  ...
  [346] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_tag_open_repeat1, 2, 0, 0),
  [348] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_tag_open_repeat1, 2, 0, 0), SHIFT_REPEAT(56),
  [351] = {.entry = {.count = 1, .reusable = false}}, SHIFT(109),
  [353] = {.entry = {.count = 1, .reusable = false}}, SHIFT(55),
  [355] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpolation_repeat1, 2, 0, 0),
  [357] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpolation_repeat1, 2, 0, 0), SHIFT_REPEAT(59),
  ...
  [366] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(99),
  ...
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 4, 0, 0),
  [381] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_annotation, 3, 0, 0),
  [383] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hash_item, 2, 0, 0),
  [385] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_annotation, 4, 0, 0),
  [387] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3, 0, 0),
  [389] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_markdown, 1, 0, 0),
  [391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 4, 0, 0),
  [393] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 3, 0, 0),
  [395] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hash_key_value, 3, 0, 0),
  [397] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__array_item_with_optional_comma, 1, 0, 0),
  [399] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [401] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [403] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_interior, 1, 0, 0),
  ...
  [415] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__hash_item_with_optional_comma, 1, 0, 0),
  [417] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_sigil, 1, 0, 0),
  ...
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_close, 2, 0, 4),
  [429] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hash_key, 1, 0, 6),
  ...
  [447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hash_key, 1, 0, 0),
  [449] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable_segment_value, 1, 0, 0),
  [451] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [453] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_self_closing, 2, 0, 0),
