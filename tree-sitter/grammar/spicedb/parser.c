...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_type, 1, 0, 0),
  ...
  [32] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(42),
  ...
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_userset, 1, 0, 7),
  [44] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [46] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_userset, 1, 0, 7),
  [48] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [50] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [52] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_object_definition_repeat1, 2, 0, 0),
  [56] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  [62] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_userset, 1, 0, 0),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_permission_expr, 1, 0, 0),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_permission, 4, 0, 8),
  [70] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_permission_expr, 1, 0, 0),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_computed_userset, 3, 0, 13),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_permission_expr, 3, 0, 0),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wildcard_type, 3, 0, 0),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference_type, 3, 0, 11),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 6),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_relation_expr, 1, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_expr, 1, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_relation_expr, 3, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_type, 2, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_caveat, 2, 0, 12),
  [100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_caveat_definition_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_caveat_definition_repeat1, 2, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object_definition, 4, 0, 1),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object_definition, 5, 0, 3),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_caveat_definition, 8, 0, 10),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_caveat_definition, 7, 0, 9),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_caveat_definition, 9, 0, 14),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_type_identifier, 1, 0, 4),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2, 0, 5),
  ...
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_identifier, 1, 0, 2),
...
TS_PUBLIC const TSLanguage *tree_sitter_spicedb(void) {
