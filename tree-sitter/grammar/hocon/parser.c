...
enum ts_symbol_identifiers {
  ...
  sym_path = 148,
  sym_value = 149,
  sym__pair_separator = 150,
  aux_sym__string_content = 151,
...
static const TSCharacterRange aux_sym_unquoted_path_token1_character_set_2[] = {
  {0, '\t'}, {0x0b, ' '}, {'%', '%'}, {'\'', ')'}, {'-', '-'}, {'0', '9'}, {';', '<'}, {'>', '>'},
  {'@', 'Z'}, {'_', '_'}, {'a', 'z'}, {'|', '|'}, {'~', 0x10ffff},
};

static const TSCharacterRange aux_sym_unquoted_path_token1_character_set_3[] = {
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 178:
      ...
      END_STATE();
    case 179:
      if ((!eof && set_contains(aux_sym_unquoted_path_token1_character_set_3, 13, lookahead))) ADVANCE(394);
      END_STATE();
    case 180:
      if ((!eof && set_contains(sym_unquoted_string_character_set_2, 13, lookahead))) ADVANCE(381);
      END_STATE();
    case 181:
      if ((!eof && set_contains(aux_sym_unquoted_path_token1_character_set_2, 13, lookahead))) ADVANCE(394);
      END_STATE();
    case 182:
      if (eof) ADVANCE(188);
      if (lookahead == '\n') ADVANCE(189);
      ...
      if ((!eof && set_contains(aux_sym_unquoted_path_token1_character_set_3, 13, lookahead))) ADVANCE(381);
      END_STATE();
    case 183:
      if (eof) ADVANCE(188);
      if (lookahead == '\n') ADVANCE(189);
    ...
    case 234:
      ...
      if (lookahead == '\t' ||
          (0x0b <= lookahead && lookahead <= '\r')) ADVANCE(234);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(203);
      if ((!eof && set_contains(aux_sym_unquoted_path_token1_character_set_3, 13, lookahead))) ADVANCE(381);
      END_STATE();
    case 235:
      ...
      if (lookahead == 't') ADVANCE(330);
      if (lookahead == '\t' ||
          (0x0b <= lookahead && lookahead <= '\r')) ADVANCE(235);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(203);
      if ((!eof && set_contains(aux_sym_unquoted_path_token1_character_set_3, 13, lookahead))) ADVANCE(381);
      END_STATE();
    case 236:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [438] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_content, 2, 0, 0), SHIFT_REPEAT(139),
  [441] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__string_content, 2, 0, 0), SHIFT_REPEAT(139),
